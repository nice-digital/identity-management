...
export const validateRegistrationValidationMessages = () => {
  ...
  checkContainsText("element", selectors.registrationPage.emailValidationMessage, "Email address is in an invalid format");
  setInputField("set", "123abc", selectors.registrationPage.passwordInput);
  setInputField("set", "123abc", selectors.registrationPage.confirmPasswordInput);
  checkContainsText("element", selectors.registrationPage.passwordValidationMessage, "Please provide a password with least 8 characters in length, contain at least 3 of the following 4 types of characters: lower case letters (a-z), upper case letters (A-Z), numbers (i.e. 0-9) and special characters (e.g. !@#$%^&*)");
}
