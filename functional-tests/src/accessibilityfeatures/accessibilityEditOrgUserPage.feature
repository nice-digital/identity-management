Feature: Accessibility testing on edit organisation user page
  As a user of NICE Identity organisation admin page
  We can check accessibility on edit organisation user page
  ...
  Scenario: Accessibility testing on edit organisation user page
